...
class Login_Window:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\annam\Desktop\Face_Recognition\college_images\loginbg.jpg")
        ...
        img1=Image.open(r"C:\Users\annam\Desktop\Face_Recognition\college_images\login.jpg")
        ...
        #icon image
        img2=Image.open(r"C:\Users\annam\Desktop\Face_Recognition\college_images\login.jpg")
        img2=img2.resize((25,25),Image.ANTIALIAS)
        self.photoimage2=ImageTk.PhotoImage(img2)
        lblimg1=Label(image=self.photoimage2,bg="black",borderwidth=0)
        lblimg1.place(x=650,y=323,width=25,height=25)
        
        img3=Image.open(r"C:\Users\annam\Desktop\Face_Recognition\college_images\password.jpg")
    ...
    def login(self):
        ...
        #elif self.txtuser.get()=="pooja" and self.txtpass.get()=="daddy":
           # messagebox.showinfo("Success","Welcome to Face recognition Attendance System")
        else:
            conn=mysql.connector.connect(host="localhost",username="root",password="daddy",database="sql1")
            my_cursor=conn.cursor()
            my_cursor.execute("select * from login_details where email=%s and password=%s",(
                                                                                    self.txtuser.get(),
                                                                                    self.txtpass.get()
                                                                            ))
            ...
            if row==None:
                ...
                open_main=messagebox.askyesno("Access","Are you sure you want to login")
                if open_main>0:
                    self.new_window=Toplevel(self.root)
    ...
    def reset_pass(self):
        if self.combo_security_Q.get()=="Select":
            ...
            conn=mysql.connector.connect(host="localhost",username="root",password="daddy",database="sql1")
            my_cursor=conn.cursor()
            query1=("select * from login_details where email=%s and securityQ=%s and securityA=%s")      
            ...
            if row==None:
                ...
                query1=("update login_details set password=%s where email=%s")
                value1=(self.txt_newpass.get(),self.txtuser.get())
                my_cursor.execute(query1,value1)
                
                conn.commit()
                conn.close()
                messagebox.showinfo("Info","Your password has been set,please login with new password",parent=self.root2)
                self.root2.destroy()
    ...
    def forgot_password_window(self):
        if self.txtuser.get()=="":
            ...
            if row==None:
                ...
                l=Label(self.root2,text="Forgot Password",font=("times new roman",15,"bold"),bg="white",fg="black")
                ...
                self.combo_security_Q["values"]=("Select","What is your School Name","What is your Favourite Colour","what is your Pet Name")
                self.combo_security_Q.place(x=50,y=1100,width=250)
...
class Register:
    def __init__(self,root):
        ...
        #left image
        self.bg1=ImageTk.PhotoImage(file=r"C:\Users\annam\Desktop\Face_Recognition\college_images\face detection.jpg")
        ...
        self.combo_security_Q=ttk.Combobox(frame,textvariable=self.var_securityQ,font=("times new roman",13,"bold"),state="readonly",width=20)
        self.combo_security_Q["values"]=("Select","What is your School Name","What is your Favourite Colour","what is your Pet Name")
        ...
        #buttons
        img=Image.open(r"C:\Users\annam\Desktop\Face_Recognition\college_images\registerbtn.jpg")
        ...
        img1=Image.open(r"C:\Users\annam\Desktop\Face_Recognition\college_images\loginbtn.jpg")
        img1=img1.resize((200,45),Image.ANTIALIAS)
        self.photoimage1=ImageTk.PhotoImage(img1)
        b2=Button(frame,image=self.photoimage1,command=self.return_login,borderwidth=0,cursor="hand2",font=("times new roman",15,"bold"),bg="white",fg="black")
    ...
    def register_data(self):
        if self.var_fname.get()=="" or self.var_email.get()=="" or self.var_securityQ.get()=="Select":
            ...
            if row!=None:
                ...
                my_cursor.execute("insert into login_details values(%s,%s,%s,%s,%s,%s,%s)",(
                                                                                        self.var_fname.get(),
                                                                                        self.var_lname.get(),
